...
const tweets = [{ id: '1972495491666710839' }, { id: '1973906028292157776' }];

export default function TwitterHighlights() {
  return (
    <section className="bg-gradient-to-b from-white via-white/80 to-[var(--color-company-bg)] py-20 flex flex-col items-center justify-center">
      ...
      {/* ✅ 2 colonnes centrées */}
      <div className="mt-16 grid gap-8 sm:grid-cols-1 md:grid-cols-2 justify-center">
        {tweets.map((tweet) => (
          <article
            key={tweet.id}
