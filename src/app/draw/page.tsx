    ...
    <div className="flex h-screen flex-col bg-slate-100">
      <header className="flex items-center justify-between border-b border-slate-200 bg-white px-6 py-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-3 text-sm font-medium text-slate-500">
              <span className="flex items-center gap-1 rounded-full bg-slate-900/5 px-3 py-1 text-xs uppercase tracking-[0.22em] text-slate-600">
                Ritual
              </span>
        ...
        <div className="flex items-center gap-3">
          ...
          <Button className="bg-slate-900 text-white shadow-[0_25px_60px_-45px_rgba(15,23,42,0.65)] hover:bg-slate-800">
      ...
      <div className="flex flex-1 overflow-hidden">
          ...
          <div className="border-t border-slate-200 px-5 pb-6 pt-5">
            ...
            <div className="mt-4 space-y-3">
              {templates.map((template) => (
                <div key={template.id} className="rounded-3xl border border-slate-200 bg-white p-4">
        ...
        <main className="flex flex-1 flex-col overflow-hidden">
          <div className="grid grid-cols-1 gap-4 border-b border-slate-200 bg-white px-6 py-6 lg:grid-cols-[1.6fr,1fr]">
            <div>
          ...
          <div className="relative flex flex-1 flex-col overflow-hidden bg-slate-100 p-6">
            <div className="relative flex-1 overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-[0_45px_120px_-60px_rgba(15,23,42,0.35)]">
              <Excalidraw
            ...
            <div className="pointer-events-none absolute bottom-8 left-1/2 flex -translate-x-1/2 items-center gap-3 rounded-full border border-slate-200 bg-white px-5 py-3 text-xs font-medium text-slate-500 shadow-[0_25px_70px_-60px_rgba(15,23,42,0.45)]">
              ...
              <span className="pl-2 text-xs text-slate-400">Live cursors synced • Auto-saving</span>
            </div>
          </div>
        </main>
